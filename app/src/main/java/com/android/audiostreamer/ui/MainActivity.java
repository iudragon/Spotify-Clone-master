...
import com.android.audiostreamer.client.MediaBrowserHelper;
import com.android.audiostreamer.client.MediaBrowserHelperCallback;
import com.android.audiostreamer.models.Artist;
import com.android.audiostreamer.services.MediaService;
import com.android.audiostreamer.util.MainActivityFragmentManager;
...
import static com.android.audiostreamer.util.Constants.MEDIA_QUEUE_POSITION;
import static com.android.audiostreamer.util.Constants.QUEUE_NEW_PLAYLIST;
import static com.android.audiostreamer.util.Constants.SEEK_BAR_MAX;
import static com.android.audiostreamer.util.Constants.SEEK_BAR_PROGRESS;
        ...
        MediaBrowserHelperCallback
{
    ...
    private int[] b1 = {0,0};
    // Vars
    float loc11,loc12,loc21,loc22,loc31,loc32;
    SimpleTarget s1,s2,s3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v1 = findViewById(R.id.progress_bar);
    ...
    void spotlight(){
        s1 = new SimpleTarget.Builder(this)
                .setPoint(loc11,loc12)
                .setShape(new Circle(v1.getWidth()))
                .setTitle("MediaProgressBar")
                .setDescription("This is awesome")
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        v1.getLocationOnScreen(b1);
        loc11 = b1[0] + v1.getWidth()/2f;
        loc12 = b1[1] + v1.getHeight()/2f;
        spotlight();
        startSpotlight();
    }
    ...
    private void startSpotlight() {
        Spotlight.with(this)
                .setOverlayColor(android.R.color.background_light)
                .setDuration(1000)
                ...
                .setOnSpotlightStateListener(new OnSpotlightStateChangedListener() {
                    ...
                    public void onStarted() {
                        Toast.makeText(mMyApplication, "Started", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onEnded() {
                        Toast.makeText(mMyApplication, "Closed", Toast.LENGTH_SHORT).show();
                    }
                })
    }
